...
import (
	"context"
	v1 "github.com/jackistom/kubectl-Ecs/pkg/apis/bolingcavalry/v1"
...
type StudentsGetter interface {       //返回crd类型接口
	Students(namespace string) StudentInterface
}

// StudentInterface has methods to work with Student resources. 关于自创crd类型得interface里面封装着有类型操作
